 ...
 *         GET,POST,DELETE and their respective URL mappings class level request
 *         mapping as "countries" return type is JSON
 */
...
public class CountryController {
	...
	@RequestMapping(value = "/countries/create/{id}/{name}/{popu}", produces = "application/json", method = RequestMethod.POST)
	// headers="Accept=application/json",
	public List<Country> createCountry(@PathVariable String id,
			@PathVariable String name, @PathVariable String popu,
			ModelAndView model) {
